...
import com.kotlinnlp.api.model.NumExpr

/**
 * Test the `getNumbers` method of the KotlinNLP APIs.
 *
...
fun main(args: Array<String>) {
  ...
  inputLoop {
    ...
    val numbers: List<NumExpr> = client.getNumbers(InputText().text(it), false)
